 ...
 * 	すべてのコンストラクタの働きを確認できるようにすること。<br>
 *
 * 作成日:2022/03/17<br>
 * 修正日:2023/04/04<br>
 * ver:1.1.0
...
public class Ensyu09_02 {
	...
	/**
	 * 日付を決める(日付クラスのインスタンスを作成する）
	 * @param dayList 既に登録してある日付クラスのインスタンスが登録順に保存してあるList
	 */
	...
	/**
	 * 日付No.を指定して登録日付データを表示する
	 * @param nameList 日付タイトル
	 * @param dayList 日付
	 * @param selectIdx 日付No.
	 */
	...
	/**
	 * 選択した日付No.の登録日付データの指定ymdを変更する
	 * @param nameList 日付タイトルデータ
	 * @param dayList 日付データ
	 * @param selectIdx 日付No.
	 */
