 ...
 * 	・給油のためのメソッドを追加する・・・メソッド：refuelingFuel（ fuel(L) += refuelingFuel(L) ）<br>
 * 
 * 作成日:2022/03/16<br>
 * 修正日:2023/03/16<br>
 * ver:1.1.0
...
class Car {
	...
	/**
	 * dist移動するのに必要な燃料量を取得・・・★追加
	 * @param dist 移動距離（スカラー）
	 * @return 燃料
	 */
